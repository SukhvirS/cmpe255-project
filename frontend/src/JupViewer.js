...
class JupViewer extends React.Component {
    state = {
        ...
        background_input_theme: '#f3f3f1',
        background_output_theme: '#f3f3f1',
        loading: true,
        notebook_json: null,
    ...
    themeChanger(ev) {
        if (ev) {
            this.setState({
                ...
                // background_input_theme: '#2F3129',
                background_input_theme: '#ecece9',
                background_output_theme: '#ecece9',
            })
        }
        else {
            this.setState({
                        ...
                        <div className={this.state.ed_theme}>
                            ...
                            >
                                ...
                                <Row>
                                    <Col span={1}></Col>
                                    <Col span={20}>
                                        <Tag color="blue" style={{ float: 'left' }}>{this.state.loading ? "Loading" : this.state.notebook_json['metadata']['kernelspec']['display_name']}</Tag>
                                        {/* <Switch
                                            style={{
                                                margin: '0px 5px'
                                            }}
